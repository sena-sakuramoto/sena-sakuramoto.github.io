...
const LAYER_RGB = {
  ...
  COUNTER: [90, 140, 60], TABLE: [62, 106, 150], CHAIR: [150, 144, 134],
  AISLE: [200, 196, 186], WC: [150, 80, 160], ENTRANCE: [190, 160, 40],
};
...
async function build3dm(elements) {
  ...
  for (const e of elements) {
    ...
    if (e.label) {
      doc.objects().addTextDot(e.label, [e.x + e.w / 2, e.y + e.h / 2, 0], attrs);
    }
    pl.delete();
    attrs.delete();
  }
